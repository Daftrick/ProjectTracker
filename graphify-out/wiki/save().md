...
sequenceDiagram
    ...
    participant P116 as parse_ldm_csv()
    participant P117 as new_id()
    participant P118 as validate_csv_catalog_items()
    participant P119 as validate_ldm_form()
    participant P120 as ldm_from_form()
    participant P121 as parse_csv_plano_filename()
    participant P122 as _hydrate_import_items()
    participant P123 as _flash_csv_catalog_errors()
    participant P124 as import_ldm_pdf_upload()
    participant P125 as _build_export_like_xlsx()
    participant P126 as .tearDown()
    participant P127 as import_json()
    participant P128 as alcances_api_save()
    participant P129 as disciplinas_api_save()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
