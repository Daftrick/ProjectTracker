...
> God node · 110 connections · [/Users/macbook/ProjectTracker/tracker/storage.py](file:///Users/macbook/ProjectTracker/tracker/storage.py#L49)
...
sequenceDiagram
    ...
    participant P149 as parse_ldm_csv()
    participant P150 as new_id()
    participant P151 as validate_csv_catalog_items()
    participant P152 as validate_ldm_form()
    participant P153 as ldm_from_form()
    participant P154 as parse_csv_plano_filename()
    participant P155 as _hydrate_import_items()
    participant P156 as _flash_csv_catalog_errors()
    participant P157 as import_ldm_pdf_upload()
    participant P158 as _build_export_like_xlsx()
    ...
    participant P173 as .tearDown()
    participant P174 as import_json()
    participant P175 as alcances_api_save()
    participant P176 as disciplinas_api_save()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
