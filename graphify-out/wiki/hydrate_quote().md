...
> God node · 21 connections · [/Users/macbook/ProjectTracker/tracker/catalog.py](file:///Users/macbook/ProjectTracker/tracker/catalog.py#L332)
...
sequenceDiagram
    ...
    participant P116 as compute_consistency()
    ...
    participant P127 as safe_float()
    participant P128 as hydrate_quote_item()
    participant P129 as quote_section_groups()
    participant P130 as _build_resumen()
    participant P131 as is_quote_section_marker()
    participant P132 as _quote_preview_from_csv()
    participant P133 as _build_quote_workbook()
    participant P134 as .test_hydrate_quote_keeps_section_markers_out_of_totals()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
...
- [[.test_hydrate_quote_keeps_section_markers_out_of_totals()]] `INFERRED`
