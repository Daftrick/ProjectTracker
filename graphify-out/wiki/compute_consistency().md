...
sequenceDiagram
    ...
    participant P124 as quote_type_key()
    participant P125 as aggregate_quote_items()
    participant P126 as _round()
    participant P127 as aggregate_ldm_items()
    participant P128 as _safe_float()
    participant P129 as .test_full_report_with_general_quote()
    participant P130 as .test_warning_threshold()
    participant P131 as .test_critical_when_ldm_exceeds_cot()
    participant P132 as _quote_visual_row()
    participant P133 as classify_margin()
    participant P134 as _ldm_visual_row()
    participant P135 as .test_no_general_quote_uses_fallback()
    participant P136 as .test_filters_by_project_id()
    participant P137 as .test_visual_warnings_include_missing_data_and_unlinked_rows()
    participant P138 as .test_active_extras_are_included_in_visual_total()
    participant P139 as _active_base_quotes()
    participant P140 as _active_extra_quotes()
    participant P141 as _catalog_coverage_pct()
    participant P142 as _synthetic_quote()
    participant P143 as _visual_warnings()
    participant P144 as .test_no_data_when_empty()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
