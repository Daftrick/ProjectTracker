...
> God node · 53 connections · [/Users/macbook/ProjectTracker/tracker/storage.py](file:///Users/macbook/ProjectTracker/tracker/storage.py#L63)
...
sequenceDiagram
    ...
    participant P112 as compute_consistency()
    participant P113 as hydrate_quote()
    participant P114 as pick_active_quote()
    participant P115 as hydrate_ldm()
    participant P116 as is_base_quote_type()
    participant P117 as build_consistency_view()
    participant P118 as build_quote_row_views()
    participant P119 as build_task_row_views()
    participant P120 as build_ldm_row_views()
    participant P121 as check_blocked()
    participant P122 as project_detail()
    participant P123 as .test_build_project_detail_context_groups_and_calculates_totals()
    participant P124 as upsert_mobile_draft()
    participant P125 as next_quote_number()
    participant P126 as apply_task_status_change()
    participant P127 as build_progress_pdf()
    participant P128 as _render_quote_form()
    participant P129 as finalize_mobile_draft()
    participant P130 as _quote_preview_from_csv()
    participant P131 as delete_catalog_items_data()
    participant P132 as build_scope_task()
    participant P133 as create_project_with_tasks()
    participant P134 as project_progress_pdf()
    participant P135 as create_project()
    participant P136 as sync_project_alcances()
    participant P137 as update_observation_details()
    participant P138 as quote_default_numbers()
    participant P139 as update_observation_checklist_item()
    participant P140 as today_short()
    participant P141 as backup_auth_db()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
