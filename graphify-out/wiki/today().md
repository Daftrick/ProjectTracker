...
sequenceDiagram
    ...
    participant P167 as add_payment()
    participant P168 as upsert_mobile_draft()
    participant P169 as _render_quote_form()
    participant P170 as next_quote_number()
    participant P171 as apply_task_status_change()
    participant P172 as build_progress_pdf()
    participant P173 as finalize_mobile_draft()
    participant P174 as _quote_preview_from_csv()
    participant P175 as _normalize_payment()
    participant P176 as delete_catalog_items_data()
    participant P177 as build_scope_task()
    participant P178 as create_project_with_tasks()
    participant P179 as project_progress_pdf()
    participant P180 as create_project()
    participant P181 as sync_project_alcances()
    participant P182 as update_observation_details()
    participant P183 as quote_default_numbers()
    participant P184 as update_observation_checklist_item()
    participant P185 as today_short()
    participant P186 as backup_auth_db()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
