...
sequenceDiagram
    ...
    participant P115 as compute_consistency()
    ...
    participant P127 as upsert_mobile_draft()
    participant P128 as next_quote_number()
    participant P129 as _render_quote_form()
    participant P130 as apply_task_status_change()
    participant P131 as build_progress_pdf()
    participant P132 as finalize_mobile_draft()
    participant P133 as _quote_preview_from_csv()
    participant P134 as delete_catalog_items_data()
    participant P135 as build_scope_task()
    participant P136 as create_project_with_tasks()
    participant P137 as project_progress_pdf()
    participant P138 as create_project()
    participant P139 as sync_project_alcances()
    participant P140 as update_observation_details()
    participant P141 as quote_default_numbers()
    participant P142 as update_observation_checklist_item()
    participant P143 as today_short()
    participant P144 as backup_auth_db()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
