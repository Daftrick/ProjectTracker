...
> God node · 57 connections · [/Users/macbook/ProjectTracker/tracker/storage.py](file:///Users/macbook/ProjectTracker/tracker/storage.py#L66)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as today()
    ...
    participant P147 as hydrate_quote()
    participant P148 as compute_consistency()
    participant P149 as pick_active_quote()
    participant P150 as hydrate_ldm()
    participant P151 as is_base_quote_type()
    participant P152 as build_quote_row_views()
    participant P153 as get_quote_status_labels()
    participant P154 as build_consistency_view()
    participant P155 as payment_summary()
    participant P156 as get_payments_for_project()
    participant P157 as build_task_row_views()
    participant P158 as build_ldm_row_views()
    participant P159 as check_blocked()
    participant P160 as project_detail()
    participant P161 as .test_context_totals_match_discounted_quote()
    participant P162 as .test_build_project_detail_context_groups_and_calculates_totals()
    participant P163 as .test_build_project_detail_context_sums_all_active_base_quotes()
    participant P164 as .test_build_project_detail_context_computes_total_pagado_and_saldo()
    participant P165 as .test_build_project_detail_context_saldo_can_go_negative_when_overpaid()
    participant P166 as add_payment()
    participant P167 as upsert_mobile_draft()
    participant P168 as _render_quote_form()
    participant P169 as next_quote_number()
    participant P170 as apply_task_status_change()
    participant P171 as build_progress_pdf()
    participant P172 as finalize_mobile_draft()
    participant P173 as _quote_preview_from_csv()
    participant P174 as _normalize_payment()
    participant P175 as delete_catalog_items_data()
    participant P176 as build_scope_task()
    participant P177 as create_project_with_tasks()
    participant P178 as project_progress_pdf()
    participant P179 as create_project()
    participant P180 as sync_project_alcances()
    participant P181 as update_observation_details()
    participant P182 as quote_default_numbers()
    participant P183 as update_observation_checklist_item()
    participant P184 as today_short()
    participant P185 as backup_auth_db()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
...
- [[add_payment()]] `INFERRED`
- [[upsert_mobile_draft()]] `INFERRED`
- [[import_ldm_csv_upload()]] `INFERRED`
- [[_render_quote_form()]] `INFERRED`
- [[next_quote_number()]] `INFERRED`
- [[new_quote()]] `INFERRED`
...
- [[view_quote()]] `INFERRED`
- [[apply_task_status_change()]] `INFERRED`
- [[build_progress_pdf()]] `INFERRED`
- [[import_ldm_pdf_map()]] `INFERRED`
- [[update_bundle_version()]] `INFERRED`
- [[finalize_mobile_draft()]] `INFERRED`
