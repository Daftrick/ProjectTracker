# Graph Report - ProjectTracker  (2026-06-10)

## Corpus Check
- 57 files · ~87,731 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1177 nodes · 3033 edges · 41 communities detected
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 569 edges (avg confidence: 0.8)
...
8. `active_drive_paths()` - 24 edges
9. `parse_ldm_csv()` - 23 edges
10. `_quote()` - 20 edges
...
Cohesion: 0.05
Nodes (83): ldm_pdf(), _project_drive_folder(), create_delivery(), create_drive_folder(), Crea la carpeta Drive del proyecto si aún no existe., Crea la carpeta Drive del proyecto si aún no existe., serve_project_file(), quote_pdf() (+75 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (75): approve_quote_route(), _build_quote_workbook(), delete_quote(), edit_quote(), _find_project(), _flash_csv_catalog_errors(), import_quote_csv(), import_quote_csv_drive() (+67 more)
...
Cohesion: 0.09
Nodes (34): _blank_project_form_state(), close_project(), dashboard(), delete_delivery(), delete_project(), new_project(), project_detail(), reopen_project() (+26 more)
...
Cohesion: 0.14
Nodes (36): api_ldm_set_costo(), _attach_csv_item_metadata(), _bundle_suggestion_ldm(), _clean_form_text(), _clear_pdf_import(), _csv_already_imported(), _csv_item_lookup(), _csv_number() (+28 more)
...
- **Thin community `Community 31`** (7 nodes): `ConversionRulesTest`, `.test_aggregate_ldm_converts_to_expected_id()`, `.test_compare_expected_vs_actual_marks_shortage_and_excess()`, `.test_ldm_piece_to_cot_linear_meter()`, `.test_tolerance_accepts_small_differences()`, `test_comparison_rules.py`, `test_comparison_rules.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (6 nodes): `test_quote_sections.py`, `test_quote_sections.py`, `QuoteSectionsTest`, `.test_quote_form_rebuilds_repeated_section_headers()`, `.test_quote_section_groups_preserve_contiguous_order()`, `test_quote_sections.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `load()` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 12`, `Community 13`, `Community 14`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `parse_quote_csv()` connect `Community 6` to `Community 1`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `parse_ldm_csv()` connect `Community 7` to `Community 13`?**
...
- **Are the 40 inferred relationships involving `today()` (e.g. with `next_quote_number()` and `delete_catalog_items_data()`) actually correct?**
