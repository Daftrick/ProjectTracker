...
from .domain import APP_VERSION, STAGES, TASK_STATUSES, TIPOS_FICHA, currency, fdate, get_alcances, get_alcances_by_id, get_disciplinas, get_info_ext_excluded
...
def create_app():
    ...
    def inject_globals():
        return {
            ...
            "disciplinas_catalog": get_disciplinas(),
